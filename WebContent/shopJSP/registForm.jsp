			...
			<fieldset>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="id" name="id"
						placeholder="Enter id" onchange="changeId()">
					<input class="btn btn-default" type="button" value="중복체크" onclick="checkId()">
				</div>
				<br> <br>
				<!-- pwd -->
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="email_id" value="">
						@
						<input type="text" class="form-control" id="domain_text" value="" placeholder="직접입력">
						<select class="form-control" id="domain" onchange="mailChange()">
							...
							class="radio-inline"><input type="radio"
							name="memberletter" value="no">아니오</label> <br>
					</div>
					<br> <br>
					<!--전화번호 -->
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="roadAddress" placeholder="도로명주소" readonly size="30" value=""> 
						<input type="text" class="form-control" id="jibunAddress" placeholder="지번주소" readonly size="30">
						<input type="text" class="form-control" id="detailAddress" placeholder="상세주소"size="50">
						<span id="guide" style="color: #999"></span>
					</div>
					<br> <br>
			</fieldset>
			<div class="form-group" align="center">
				<input class="btn btn-default" type="button" value="회원가입" onclick="regist()">
