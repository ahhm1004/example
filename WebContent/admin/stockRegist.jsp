	...
	<div class="container">
		...
		<form class="form-horizontal" role="form" name="registForm">
			...
			<div class="form-group">
				...
				<div class="col-sm-1">
					<input class="form-control" name="size_s" type="text" value="">
				</div>
				<div class="col-sm-1">
					<input class="form-control" name="size_m" type="text" value="">
				</div>
				<div class="col-sm-1">
					<input class="form-control" name="size_l" type="text" value="">
				</div>
				<div class="col-sm-1">
					<input class="form-control" name="size_xl" type="text" value="">
				</div>
				<div class="col-sm-1">
					<input class="form-control" name="size_xxl" type="text" value="">
				</div>
				<div class="col-sm-1">
					<input class="form-control" name="size_free" type="text" value="">
				</div>								
			</div>
